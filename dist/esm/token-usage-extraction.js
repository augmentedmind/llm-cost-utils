 ...
 */
export function extractTokenUsageFromResponseBody(responseBody) {
 ...
 */
export function isSSEResponseBody(responseBody) {
 ...
 */
export function extractTokenUsageFromStreamingResponseBody(responseText) {
 ...
 */
export function extractTokenUsageFromResponse(responseBody) {
    // Throw error for null or undefined input
    if (responseBody === null || responseBody === undefined) {
        throw new TokenUsageExtractionError('Token usage extraction failed: responseBody is null or undefined');
    }
