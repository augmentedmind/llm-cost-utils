...
exports.TokenUsageExtractionError = void 0;
exports.extractTokenUsageFromResponseBody = extractTokenUsageFromResponseBody;
exports.isSSEResponseBody = isSSEResponseBody;
exports.extractTokenUsageFromStreamingResponseBody = extractTokenUsageFromStreamingResponseBody;
exports.extractTokenUsageFromResponse = extractTokenUsageFromResponse;
/**
...
function extractTokenUsageFromResponse(responseBody) {
    ...
    try {
        ...
        if (isSSEResponseBody(responseBody)) {
            return extractTokenUsageFromStreamingResponseBody(responseBody);
        }
        else {
