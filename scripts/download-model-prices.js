...
const OUTPUT_FILE = path.join(OUTPUT_DIR, 'model-prices.js')
  ...
  .get(MODEL_PRICES_URL, (response) => {
    ...
    response.on('end', () => {
      try {
        ...
        const jsContent = `// Auto-generated model prices data
// Do not edit this file manually - it will be overwritten by the download script

export const modelPricesData = ${JSON.stringify(modelPrices, null, 2)};
`

        // Generate TypeScript declaration file
        const dtsContent = `// Auto-generated type declarations for model prices data
// Do not edit this file manually - it will be overwritten by the download script
