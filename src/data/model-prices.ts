// Auto-generated model prices data
// Do not edit this file manually - it will be overwritten by the download script

export const modelPricesData = {
  sample_spec: {
    max_tokens:
      "LEGACY parameter. set to max_output_tokens if provider specifies it. IF not set to max_input_tokens, if provider specifies it.",
    max_input_tokens:
